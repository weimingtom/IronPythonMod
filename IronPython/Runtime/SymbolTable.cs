...
namespace IronPython.Runtime {
    ...
    /// </summary>
    [PythonType(typeof(Dict))]
    public abstract class CustomFieldIdDict : IDictionary, IDictionary<object, object>, IAttributesDictionary,
                                              IMapping, ICloneable, IRichEquality, IRichComparable {
        Dictionary<SymbolId, object> data;

        protected CustomFieldIdDict() {
        }
    ...
    class ExtraKeyEnumerator : IDictionaryEnumerator {
        CustomFieldIdDict idDict;
        int curIndex = -1;

        public ExtraKeyEnumerator(CustomFieldIdDict idDict) {
            this.idDict = idDict;
        }
