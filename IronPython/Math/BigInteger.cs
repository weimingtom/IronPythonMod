    ...
    public class BigInteger : IFormattable, IComparable, IConvertible {
        ...
        public static implicit operator double(BigInteger i) {
            if (object.ReferenceEquals(i, null)) {
                throw new ArgumentException("InvalidArgument", "i");
            }
            return i.ToFloat64();
        }
        ...
        public uint ToUInt32() {
            ...
            throw new OverflowException("BigIntWontFitUInt");
        }

        public int ToInt32() {
            int ret;
            if (AsInt32(out ret)) return ret;
            throw new OverflowException("BigIntWontFitInt");
        }

        public long ToInt64() {
            long ret;
            if (AsInt64(out ret)) return ret;
            throw new OverflowException("BigIntWontFitLong");
        }
        ...
        public static int Compare(BigInteger x, BigInteger y) {
            if (object.ReferenceEquals(x, null)) {
                throw new ArgumentException("InvalidArgument", "x");
            }
            if (object.ReferenceEquals(y, null)) {
                throw new ArgumentException("InvalidArgument", "y");
            }
            if (x.sign == y.sign) {
                int xl = x.Length;
                int yl = y.Length;
        ...
        public string ToString(uint radix) {
            if (radix < 2) {
                throw new ArgumentOutOfRangeException("radix", radix, "RadixLessThan2");
            }
            if (radix > 36) {
                throw new ArgumentOutOfRangeException("radix", radix, "RadixGreaterThan36");
            }
        ...
        public int CompareTo(object obj) {
            ...
            if (object.ReferenceEquals(o, null)) {
                throw new ArgumentException("ExpectedInteger");
            }
        ...
        public byte ToByte(IFormatProvider provider) {
            ...
            throw new OverflowException("BigIntWontFitByte");
        }
        ...
        public char ToChar(IFormatProvider provider) {
            ...
            throw new OverflowException("BigIntWontFitChar");
        }
        ...
        public short ToInt16(IFormatProvider provider) {
            ...
            throw new OverflowException("BigIntWontFitShort");
        }
        ...
        public sbyte ToSByte(IFormatProvider provider) {
            ...
            throw new OverflowException("BigIntWontFitSByte");
        }
        ...
        public ushort ToUInt16(IFormatProvider provider) {
            ...
            throw new OverflowException("BigIntWontFitUShort");
        }
        ...
        public ulong ToUInt64(IFormatProvider provider) {
            ...
            throw new OverflowException("BigIntWontFitULong");
        }
