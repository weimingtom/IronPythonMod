...
namespace IronPython.Compiler {
    ...
    public class NewTypeMaker {
        ...
        private void OverrideSpecialName(MethodInfo mi, Dictionary<string, bool> specialNames) {
            ...
            foreach (PropertyInfo pi in pis) {
                if (pi.GetIndexParameters().Length > 0) {
                    ...
                    CreateVTableGetterOverride(mi, methField as VTableSlot);
                    break;
                } else if (mi == pi.GetSetMethod(true)) {
                    if (NameConverter.TryGetName(Ops.GetDynamicTypeFromType(mi.DeclaringType), pi, mi, out name) == NameType.None) return;
                    Slot methField = GetOrMakeField(name);
                    CreateVTableSetterOverride(mi, methField as VTableSlot);
                    break;
                } 
            }
        }
        ...
        private void EmitBaseMethodDispatch(MethodInfo mi, CodeGen cg) {
            cg.EmitThis();
        ...
        private bool CanOverride(MethodInfo mi, out int paramsIndex) {
        ...
        private void EmitBadCallThrow(CodeGen cg, MethodInfo mi, string reason) {
        ...
        /// 
        /// </summary>
        private Label EmitBaseClassCallCheck(CodeGen cg, VTableSlot methField) {
        ...
        private static void EmitBaseClassCall(CodeGen cg, MethodInfo mi) {
            if (!mi.IsAbstract) {
                cg.EmitThis();
        ...
        private void CreateVTableGetterOverride(MethodInfo mi, VTableSlot methField) {
        ...
        private void CreateVTableSetterOverride(MethodInfo mi, VTableSlot methField) {
            CodeGen cg = tg.DefineMethodOverride(mi);
            Label baseCall = EmitBaseClassCallCheck(cg, methField);
        ...
        private void CreateVirtualMethodHelper(MethodInfo mi) {
